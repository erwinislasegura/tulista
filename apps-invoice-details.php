                            ...
                            <div class="card-body">
                                ...
                                <div class="clearfix">
                                    <div class="float-sm-end">
                                        <div class="auth-logo">
                                            <img class="logo-dark me-1" src="assets/images/logo-dark-full.png" alt="logo-dark" height="24" />
                                            <img class="logo-light me-1" src="assets/images/logo-light-full.png" alt="logo-dark" height="24" />
                                        </div>
                                        <address class="mt-3">
                                            1729 Bangor St,<br>
                                            Houlton, ME, 04730 <br>
                                    ...
                                    <div class="float-sm-start">
                                        <h5 class="card-title mb-2">Invoice: #RB89562</h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="float-end">
                                            ...
                                            <p><span class="fw-medium">Discount (10%) :</span>
                                                <span class="float-end"> &nbsp;&nbsp;&nbsp; $226.659</span>
                                            </p>
                                            <h3>$2039.931 USD</h3>
                                        </div>
