...
<body>
                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart at:</span> <code> ../src/assets/js/components/apexchart-line.js</code></p>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3 anchor" id="overview">Line Chart with Annotations</h4>
                                <div dir="ltr">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3 anchor" id="gradient">Gradient Line Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="col-xl-3">
                        <div class="card docs-nav">
                            <ul class="nav bg-transparent flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="#annotations" class="nav-link">Line Chart with Annotations</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#syncing" class="nav-link">Syncing charts</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#gradient" class="nav-link">Gradient Line Chart</a>
                                </li>
                                <li class="nav-item">
    ...
    <script src="assets/js/components/apexchart-line.js"></script>
