                                        ...
                                        <div class="table-responsive table-centered">
                                             <table class="table text-nowrap mb-0">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB6985</a>
                                                            </td>
                                                            <td>
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB1002</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB3652</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB7854</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB9521</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB9634</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB8520</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB3590</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB5872</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                                      <img src="assets/images/users/avatar-9.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                                      <div>
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 <a href="apps-invoice-details.php" class="fw-medium">#RB1158</a>
                                                            </td>
                                                            <td>
                                                                 <div class="d-flex align-items-center">
                                                                      <img src="assets/images/users/avatar-10.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                                      <div>
