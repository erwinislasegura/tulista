                ...
                <div class="modal fade" id="editUsuario<?= (int) $usuario['id'] ?>" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered"><div class="modal-content"><div class="modal-body">
                        ...
                        <form method="post" class="row g-2">
                            ...
                            <div class="col-md-3"><label class="form-label">Rol</label><select name="rol" class="form-select tl-compact-input"><?php foreach (['admin','supervisor','vendedor','bodega'] as $rol): ?><option value="<?= $rol ?>" <?= $rol === $usuario['rol'] ? 'selected' : '' ?>><?= ucfirst($rol) ?></option><?php endforeach; ?></select></div>
