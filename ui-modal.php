                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted">When modals become too long for the user&rsquo;s viewport or
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="exampleModalCenteredScrollableTitle">Modal title</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                            ...
                            <div class="">
                                <div class="">
                                    <ul class="nav bg-transparent flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#scrolling-long-content" class="nav-link">Scrolling Long
                                                Content</a>
                                        </li>
                                        <li class="nav-item">
