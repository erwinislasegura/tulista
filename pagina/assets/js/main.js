...
const products = [{"id": 1, "name": "Resma carta 500 hojas", "cat": "Oficina", "price": 4790, "old": 5690, "img": "assets/images/prod-resma.png", "tag": "Más vendido", "desc": "Papel para impresión diaria, colegio y oficina."}, {"id": 2, "name": "Cuaderno universitario 100 hojas", "cat": "Escolar", "price": 1890, "old": 0, "img": "assets/images/prod-cuadernos.png", "tag": "Escolar", "desc": "Para clases, apuntes y uso diario."}, {"id": 3, "name": "Set lápices grafito x12", "cat": "Escritura", "price": 2490, "old": 2990, "img": "assets/images/prod-lapices.png", "tag": "Pack", "desc": "Lápices básicos para colegio y escritorio."}, {"id": 4, "name": "Témpera escolar 12 colores", "cat": "Arte", "price": 3990, "old": 4990, "img": "assets/images/prod-pinturas.png", "tag": "Arte", "desc": "Colores vivos para manualidades y trabajos escolares."}, {"id": 5, "name": "Carpeta oficio con acoclip", "cat": "Oficina", "price": 590, "old": 0, "img": "assets/images/prod-carpetas.png", "tag": "Unidad", "desc": "Organización para tareas, trámites y documentos."}, {"id": 6, "name": "Goma eva colores surtidos", "cat": "Arte", "price": 1990, "old": 0, "img": "assets/images/prod-gomaeva.png", "tag": "Manualidad", "desc": "Material flexible para proyectos creativos."}, {"id": 7, "name": "Mochila escolar resistente", "cat": "Mochilas", "price": 15990, "old": 18990, "img": "assets/images/prod-mochila.png", "tag": "Nuevo", "desc": "Compartimentos cómodos para clases y útiles."}, {"id": 8, "name": "Pack oficina mensual", "cat": "Oficina", "price": 34990, "old": 39990, "img": "assets/images/prod-oficina.png", "tag": "Empresa", "desc": "Insumos de alta rotación para oficina."}, {"id": 9, "name": "Libro lectura complementaria", "cat": "Librería", "price": 6990, "old": 0, "img": "assets/images/prod-libros.png", "tag": "Lectura", "desc": "Selección para apoyo escolar y biblioteca."}, {"id": 10, "name": "Set geometría escolar", "cat": "Escolar", "price": 1990, "old": 2490, "img": "assets/images/prod-geometria.png", "tag": "Kit", "desc": "Regla, escuadras y transportador."}, {"id": 11, "name": "Papel adhesivo A4 100 hojas", "cat": "Papelería", "price": 15320, "old": 0, "img": "assets/images/prod-etiquetas.png", "tag": "Etiquetas", "desc": "Para rotulación, etiquetas y organización."}, {"id": 12, "name": "Kit escolar básico 1º ciclo", "cat": "Escolar", "price": 24990, "old": 29990, "img": "assets/images/prod-kit.png", "tag": "Kit listo", "desc": "Pack referencial para resolver rápido la lista."}];
let cart = [];
...
function renderTabs(){
  ...
  if(!tabs) return;
  const cats = ['Todos','Escolar','Oficina','Arte','Papelería','Escritura','Librería','Mochilas'];
  tabs.innerHTML = cats.map(c=>`<button class="tab ${c===activeCategory?'active':''}" data-cat="${c}">${c}</button>`).join('');
...
function renderSideCategories(){
  ...
  if(!el) return;
  const cats = ['Todos','Escolar','Oficina','Arte','Papelería','Escritura','Librería','Mochilas'];
  el.innerHTML = cats.map(c=>`<button class="filter-btn ${c===activeCategory?'active':''}" data-cat="${c}">${c} <span>${c==='Todos'?products.length:products.filter(p=>p.cat===c).length}</span></button>`).join('');
