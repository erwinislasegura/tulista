    ...
    <nav class="nav">
      <div class="container">
        <div class="nav-left">
          ...
          <a href="index.php" data-nav class="">Inicio</a><a href="nosotros.php" data-nav class="active">Nosotros</a><a href="cotizador-lista.php" data-nav class="">Cotizador de lista</a><a href="sabias-que.php" data-nav class="">Sabías que</a><a href="contacto.php" data-nav class="">Contacto</a>
        </div>
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <img src="assets/images/about-team.png" alt="Equipo Tu Lista">
    </div>
  </section>
  <section>
