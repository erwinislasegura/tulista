...
<main>
  <section class="page-hero page-hero-bg" style="--section-bg:url('pagina/assets/source/images/6.png')">
    <div class="container">
  ...
  <section class="section-bg" style="--section-bg:url('pagina/assets/source/images/13.png')">
