    ...
    <div class="mx-auto" style="max-width: 1100px;">
        ...
        <?php else: ?>
            ...
            <ul class="nav nav-pills gap-2 mb-3">
                ...
                <li class="nav-item"><a class="nav-link" href="#aprobar">Aprobar cotización</a></li>
                <li class="nav-item"><a class="nav-link" href="#seguimiento">Seguimiento pedido</a></li>
                <li class="nav-item"><a class="nav-link" href="#consultar">Consultar producto</a></li>
